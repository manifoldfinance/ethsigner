#!/bin/bash
#
# @file JVM Container Optimizations
# @version 2021-02-23
# @summary: Java JVM normalization
# @notes: Minor adjustmnets made, utilizing bash isntead of sh
# @license: Apache-2.0
# sourced from:
# https://github.com/fabric8io-images/java/blob/51bed0172d911c77e01ff1019be3fcc22a632157/images/jboss/openjdk8/jdk/run-java.sh#L6
# ===================================================================================
